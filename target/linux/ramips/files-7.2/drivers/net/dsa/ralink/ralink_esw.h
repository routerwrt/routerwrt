...
#define RALINK_ESW_ATS				0x0024
#define   RALINK_ESW_ATS_AT_LKUP_IDLE		BIT(2)
...
#define   RALINK_ESW_ATS0_R_MC_INGRESS		BIT(2)
...
#define   RALINK_ESW_WMAD0_W_MC_INGRESS		BIT(2)
#define   RALINK_ESW_WMAD0_W_MAC_DONE		BIT(1)
#define   RALINK_ESW_WMAD0_W_MAC_CMD		BIT(0)
...
enum esw_vlan_egress_mode {
	ESW_VLAN_ACCESS = 0, /* one VID, egress untagged */
	ESW_VLAN_TRUNK,     /* one or more VIDs, egress tagged */
	ESW_VLAN_HYBRID,    /* per-VID tagged/untagged */
};
